...
public class PlayerAim : MonoBehaviour
{
    ...
    private Vector3 DesiredCameraPosition()
    {
        ...
        float distaceToDesiredDistance = Vector3.Distance(transform.position, desiredCameraPosition);
        float clampedDistance = Mathf.Clamp(distaceToDesiredDistance, minCameraDistance, actualMaxCameraDistance);
